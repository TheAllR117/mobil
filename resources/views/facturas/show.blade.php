                ...
                <table class="table tablesorter " id="simple-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img  src="{{ url('storage/order_payments/'.$estacion->estacion_id.'/'.$factura->url) }}"  style="width: 40px;" data-toggle="modal" data-target="#exampleModalLong" title="click para ampliar." onclick="imagen_mostrar('{{ url('storage/order_payments/'.$estacion->estacion_id.'/'.$factura->url) }}');"/></td>
  ...
  <div class="col-lg-4 col-md-6">
    <div class="card card-tasks">
        <div class="card-header text-center">
          <h3 class="title d-inline text-info">{{ $estacion->po }} {{ $estacion->producto }} {{ $estacion->cantidad_lts }}L</h3><br>
        </div>
        <div class="card-body">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-8 col-sm-8">
                  ...
                  ${{ number_format($estacion->costo_real, 2) }}
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-8 col-sm-8">
                  ...
                  ${{ number_format($estacion->costo_real - $facturas->where('id_status', 2)->sum('cantidad'), 2) }}
                </div>
              </div>
