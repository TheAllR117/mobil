    ...
    <div class="container-fluid">
        <div class="navbar-wrapper">
            ...
            <a class="navbar-brand m-0" href="#">
                <img class="float-left mt-3 mb-3 mr-5 pr-4 pl-1 pt-1 pb-1" src="{{ asset('white') }}/img/mobil-logo.png" alt="" width="20%">
            </a>
        </div>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-navbar">
                        <li class="nav-link">
                            <a href="#" class="nav-item dropdown-item">{{ __('No hay notificaciones.') }}</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown nav-item">
