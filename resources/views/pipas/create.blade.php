                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group{{ $errors->has('compartimentos') ? ' has-danger' : '' }} col-sm-4">
                                ...
                                <input aria-describedby="compartimentosHelp" aria-required="true" class="form-control{{ $errors->has('compartimentos') ? ' is-invalid' : '' }}" id="input-compartimentos" name="compartimentos" type="number" value="{{ old('compartimentos',1)}}">
                              ...
                              <div class="form-group{{ $errors->has('capacidad_compartimiento') ? ' has-danger' : '' }} col-sm-4">
                                ...
                                <input aria-describedby="capacidad_compartimientoHelp" aria-required="true" class="form-control{{ $errors->has('capacidad_compartimiento') ? ' is-invalid' : '' }}" id="input-capacidad_compartimiento" name="capacidad_compartimiento" type="number" value="{{ old('capacidad_compartimiento',1)}}">
