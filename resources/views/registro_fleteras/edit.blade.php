            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} mt-5 col-md-4">
                  ...
                  <input aria-describedby="nameHelp" aria-required="true" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }} mt-4"  id="input-name" name="name"  type="text" value="{{ old('name',$namefreight_edit->name)}}">
                    @if ($errors->has('name'))
                ...
                <div class="form-group{{ $errors->has('rfc') ? ' has-danger' : '' }} mt-5 col-md-4">
                  ...
                  <input aria-describedby="rfcHelp" aria-required="true" class="form-control{{ $errors->has('rfc') ? ' is-invalid' : '' }} mt-4"  id="input-rfc" name="rfc"  type="text" value="{{ old('rfc',$namefreight_edit->rfc)}}">
                    @if ($errors->has('rfc'))
                ...
                <div class="form-group{{ $errors->has('cre') ? ' has-danger' : '' }} mt-5 col-md-4">
                  ...
                  <input aria-describedby="creHelp" aria-required="true" class="form-control{{ $errors->has('cre') ? ' is-invalid' : '' }} mt-4"  id="input-cre" name="cre"  type="text" value="{{ old('cre',$namefreight_edit->cre)}}">
                    @if ($errors->has('cre'))
              ...
              <div class="row">
                 <div class="form-group{{ $errors->has('telefono') ? ' has-danger' : '' }} mt-5 col-md-4">
                  ...
                  <input aria-describedby="telefonoHelp" aria-required="true" class="form-control{{ $errors->has('telefono') ? ' is-invalid' : '' }} mt-4"  id="input-telefono" name="telefono"  type="text" value="{{ old('telefono',$namefreight_edit->telefono)}}">
                ...
                <div class="form-group{{ $errors->has('direccion') ? ' has-danger' : '' }} mt-5 col-md-4">
                  ...
                  <input aria-describedby="direccionHelp" aria-required="true" class="form-control{{ $errors->has('direccion') ? ' is-invalid' : '' }} mt-4"  id="input-direccion" name="direccion"  type="text" value="{{ old('direccion',$namefreight_edit->direccion)}}">
                ...
                <div class="form-group{{ $errors->has('contacto') ? ' has-danger' : '' }} mt-5 col-md-4">
                  ...
                  <input aria-describedby="contactoHelp" aria-required="true" class="form-control{{ $errors->has('contacto') ? ' is-invalid' : '' }} mt-4"  id="input-contacto" name="contacto"  type="text" value="{{ old('contacto',$namefreight_edit->contacto)}}">
