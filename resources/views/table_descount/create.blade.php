                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <a class="btn btn-sm btn-primary" href="{{ route('table_descount.index') }}">
                                {{ __('Volver a la lista') }}
                            </a>
                        </div>
                    </div>
                    <form action="{{ route('table_descount.store') }}" autocomplete="off" class="form-horizontal" method="post">
                        @csrf
                        @method('post')
                        <div class="row">
                        <div class="col">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input class="form-control datetimepicker" id="calendar_first" name="inicio" type="text" value="{{ $fecha_inicio }}"/>
                                </div>
                                <div class="col">
                                    <label class="label-control">
                                        Periodo Final
                                    </label>
                                    <input class="form-control datetimepicker" id="calendar_second" name="fin" type="text" value="{{ $fecha_final }}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="col">
                                            ...
                                            <input class="form-control" id="input-nombre" name="nombre/" type="hidden" value="Valero"/>
                                            <input class="form-control" id="input-vigencia_now" name="vigencia_now/" type="hidden" value="1"/>
                                            <input class="form-control" id="input-vigencia_old" name="vigencia_old/" type="hidden" value="1"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
